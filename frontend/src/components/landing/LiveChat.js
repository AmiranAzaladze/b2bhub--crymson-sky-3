      ...
      {open && (
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group flex items-center gap-3 px-3 py-2.5 mt-1 rounded-lg hover:bg-neutral-50 transition-colors"
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="text-[13.5px] font-semibold text-neutral-950 leading-tight">
                WhatsApp
              </div>
              <div className="text-[11.5px] text-neutral-500 font-mono mt-0.5">
                {WHATSAPP_NUMBER}
              </div>
            </div>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-neutral-50 transition-colors"
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[11.5px] text-neutral-500 font-mono mt-0.5 truncate">
                @B2BHub_inbox_bot
              </div>
            </div>
          </a>
